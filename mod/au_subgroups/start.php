...
function au_subgroups_init() {
  ...
  elgg_extend_view('groups/sidebar/search', 'au_subgroups/sidebar/subgroups',1);
  ...
  elgg_register_event_handler('create', 'group', 'subgroups_inherit_members', 1000);
  ...
  add_group_tool_option('subgroups_inherit_members', elgg_echo('au_subgroups:group:inheritMembers'), false);
