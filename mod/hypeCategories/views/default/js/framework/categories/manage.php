//<script>
	...
	framework.categories.manage = function() {
		...
		$('.categories-icon-minus').live('click', function(e) {
			e.preventDefault();
		...
		$('.categories-icon-info').live('click', function(e) {
		...
		$('form.elgg-form-categories-manage').submit(function(e) {
