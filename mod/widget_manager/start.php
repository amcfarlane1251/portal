<?php 
	...
	elgg_register_page_handler("river_activity", "river_get_friends");
	elgg_register_page_handler("welcomesearch", "index_search");
	elgg_register_page_handler("create_content", "get_create_forms");
	elgg_register_page_handler("share_content", "get_share_forms");

	function river_get_friends($page){
