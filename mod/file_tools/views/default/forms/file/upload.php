...
<div>
	...
	<?php
	if($groupAdmin){
		echo elgg_view('input/access', array('name' => 'access_id', 'value' => $access_id, 'admin_option' => array($container_entity->group_admin_acl => "Group Admins: ".$container_entity->name))); 
	}
	else{
