<?php 
	...
	$english = array(
		...
		//time release
		'file_tools:time_release' => "Schedule file for time release?",
		'file_tools:time_delete' => "Schedule file to delete?",
		'file_tools:date' => "Release Date",
		'file_tools:time' => "Release Time",
		'file_tools:dateClosed' => "Deletion Date",
		'file_tools:timeClosed' => "Deletion Time",

		//sort options
		'file_tools:sort:sortBy' => 'Sort Folders/Files By:',
		'file_tools:sort:title' => 'Title',
		'file_tools:sort:lastAction' => 'Latest Upload',
