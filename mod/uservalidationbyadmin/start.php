...
function uservalidationbyadmin_init() {
	...
	$action_path_alt = elgg_get_plugins_path() . 'uservalidationbyadmin/actions';
	elgg_register_action('uservalidationbyadmin/validate', "$action_path/validate.php", 'public');
	...
	elgg_register_action('uservalidationbyadmin/email', "$action_path/email.php", 'admin');
}
...
function uservalidationbyadmin_page_handler($page) {
	$base_dir = elgg_get_plugins_path() . 'uservalidationbyadmin/pages/uservalidationbyadmin';
	if (isset($page[0]) && $page[0] == 'confirm') {
		...
		include elgg_get_plugins_path().'uservalidationbyadmin/actions/validate.php';
	}
...
function uservalidationbyadmin_public_pages($hook, $type, $return_value, $params) {
	...
	$allowed_pages = array();
	$allowed_pages[] = 'uservalidationbyadmin/validate';
