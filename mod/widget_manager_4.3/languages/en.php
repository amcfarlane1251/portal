<?php 
	...
	'widget_manager:widgets:content_by_tag:viewMore' => "View More",
	'widget_manager:widgets:content_by_tag:viewLess' => "View Less",
	'widget_manager:widgets:content_by_tag:discussions' => "Discussions",
	'widget_manager:widgets:content_by_tag:blogs' => "Blogs",
	'widget_manager:widgets:content_by_tag:files' => "Files",
	'widget_manager:widgets:content_by_tag:questions' => "Questions",
	'widget_manager:widgets:content_by_tag:pages' => "Pages",
	'widget_manager:widgets:content_by_tag:bookmarks' => "Bookmarks",
	
	'widget_manager:widgets:ongarde_toolbox:instructorHeading' => "You are viewing the Instructor stream.",
	'widget_manager:widgets:ongarde_toolbox:learnerHeading' => "You are viewing the Learner stream.",
	'widget_manager:widgets:ongarde_toolbox:developerHeading' => "You are viewing the Developer stream.",
	'widget_manager:widgets:ongarde_toolbox:trainingmgrHeading' => "You are viewing the Training Mgrs/Mgmt stream.",
	'widget_manager:widgets:ongarde_toolbox:homeHeading' => "You are viewing the Home stream.",
	'widget_manager:widgets:ongarde_toolbox:home' => "Home",
	'widget_manager:widgets:ongarde_toolbox:instructors' => "Instructors",
	'widget_manager:widgets:ongarde_toolbox:learners' => "Learners",
	'widget_manager:widgets:ongarde_toolbox:developers' => "Developers",
	'widget_manager:widgets:ongarde_toolbox:trainingmgr' => "Training Mgrs/Mgmt",
	'widget_manager:widgets:ongarde_toolbox:availableTools' => "Available Tools",
	...
	'settings:user' => 'Account Settings',
		...
		'widget_manager:widgets:index_login:welcome' => "<b>%s</b> welcome to the <b>%s</b> community",
		...
		'widget_manager:widgets:image_slider:slide1title' => "Slide 1 Title",
		'widget_manager:widgets:image_slider:slide1text' => "Slide 1 Text",	
		'widget_manager:widgets:image_slider:slide2title' => "Slide 2 Title",
		'widget_manager:widgets:image_slider:slide2text' => "Slide 2 Text",
		'widget_manager:widgets:image_slider:slide3title' => "Slide 3 Title",
		'widget_manager:widgets:image_slider:slide3text' => "Slide 3 Text",
		'widget_manager:widgets:image_slider:slide4title' => "Slide 4 Title",
		'widget_manager:widgets:image_slider:slide4text' => "Slide 4 Text",
		'widget_manager:widgets:image_slider:slide5title' => "Slide 5 Title",
		'widget_manager:widgets:image_slider:slide5text' => "Slide 5 Text",

		// getting_started
		'widget_manager:widgets:getting_started:name' => "Welcome",
		'widget_manager:widgets:getting_started:discussion' => "Add Discussion",
		'widget_manager:widgets:getting_started:bookmark' => "Add Bookmark",
		'widget_manager:widgets:getting_started:files' => "Add File/Video",
		'widget_manager:widgets:getting_started:blog' => "Add Blog",
		'widget_manager:widgets:getting_started:question' => "Ask Question",
		'widget_manager:widgets:getting_started:browse' => "Browse Groups",
		'widget_manager:widgets:getting_started:submitabookmark' => "Submit a Bookmark",
