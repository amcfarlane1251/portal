<?php
	...
	if(empty($configured_slides)){
		$configured_slides = array(
			array(
				"url" => "http://s3.ongarde.net/uploads/instructors.jpg",
				"text" => "<strong>".elgg_echo('widget_manager:widgets:image_slider:slide1title')."</strong><br>".elgg_echo('widget_manager:widgets:image_slider:slide1text'),
				"link" => "http://s3.ongarde.net/elgg/groups/profile/138/instructors-les-instructeurs",
				"direction" => "bottom"
			),
			array(
				"url" => "http://s3.ongarde.net/uploads/learners.jpg",
				"text" => "<strong>".elgg_echo('widget_manager:widgets:image_slider:slide2title')."</strong><br>".elgg_echo('widget_manager:widgets:image_slider:slide2text'),
				"link" => "http://s3.ongarde.net/elgg/groups/profile/137/learner-apprenant",
				"direction" => "bottom"
			),
			array(
				"url" => "http://s3.ongarde.net/uploads/trgadmin.jpg",
				"text" => "<strong>".elgg_echo('widget_manager:widgets:image_slider:slide3title')."</strong><br>".elgg_echo('widget_manager:widgets:image_slider:slide3text'),
				"link" => "http://s3.ongarde.net/elgg/groups/profile/139/training-administrators-formation-des-administrateurs",
				"direction" => "bottom"
			),
			array(
				"url" => "http://s3.ongarde.net/uploads/developers.jpg",
				"text" => "<strong>".elgg_echo('widget_manager:widgets:image_slider:slide4title')."</strong><br>".elgg_echo('widget_manager:widgets:image_slider:slide4text'),
				"link" => "http://s3.ongarde.net/elgg/groups/profile/147/developers-les-developpeurs",
				"direction" => "bottom"
			),
			array(
				"url" => "http://s3.ongarde.net/uploads/standards.jpg",
				"text" => "<strong>".elgg_echo('widget_manager:widgets:image_slider:slide5title')."</strong><br>".elgg_echo('widget_manager:widgets:image_slider:slide5text'),
				"link" => "http://s3.ongarde.net/elgg/groups/profile/140/standards-les-normes",
				"direction" => "bottom"
			),
		);
	}
