...
if (elgg_is_xhr()) {  //This is an Ajax call!
    ...
    echo '<div class="gcconnex-portfolio-add-another elgg-button elgg-button-profile btn" data-type="portfolio" onclick="addMore(this)">' . elgg_echo('gcconnex_profile:portfolio:add') . '</div>';
}
