...
if (elgg_is_xhr()) {  //This is an Ajax call!
    ...
    echo '<br><div class="gcconnex-work-experience-add-another elgg-button elgg-button-profile btn" data-type="work-experience" onclick="addMore(this)">' . elgg_echo('gcconnex_profile:experience:add') . '</div>';
}
