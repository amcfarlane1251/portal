...
echo '<br><div class="elgg-button elgg-button-profile btn" onclick="deleteEntry(this)" data-type="work-experience">' . elgg_echo('gcconnex_profile:experience:delete') . '</div>';
