...
<li id="gcwu-gcnb-lang"><a href="./?lang=<?=$_SESSION['ongarde-lang']=="fr"?"en":"fr"?>" lang="<?=$_SESSION['ongarde-lang']=="fr"?"en":"fr"?>"><?=elgg_echo('login:toLanguage')?></a></li>
...
<!--<ul class="mb-menu">
<li><div><a target="_blank" class="first" href="./">Home</a></div></li>
</ul>-->
...
$(document).bind("mobileinit", function() {
  $("input[type='submit']").attr("data-role", "none");               
  $("input[type='password']").attr("data-role", "none");
  $("input[type='checkbox']").attr("data-role", "none");
  $("input[type='text']").attr("data-role", "none");
