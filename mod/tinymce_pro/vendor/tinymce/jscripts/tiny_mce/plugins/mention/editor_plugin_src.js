    ...
    AutoComplete.prototype = {
        ...
        show: function() {
            var rtePosition = $(this.editor.getContainer()).offset(),
                ...
                top = rtePosition.top + toolbarPosition.innerHeight() + nodePosition.top + $(this.editor.selection.getNode()).innerHeight() - $(this.editor.getDoc()).scrollTop() + 20,
            ...
            //this.$dropdown.live('click', $.proxy(this.autoCompleteClick, this));
        },
