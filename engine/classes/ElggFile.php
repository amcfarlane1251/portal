...
class ElggFile extends ElggObject {
	 ...
	 */
	public function detectMimeType($file = null, $default = null, $filename = null) {
		...
		// for PHP5 folks.
		elseif (function_exists('finfo_file') && defined('FILEINFO_MIME_TYPE')) {
		...
		// for everyone else.
		elseif (!$mime && function_exists('mime_content_type')) {
