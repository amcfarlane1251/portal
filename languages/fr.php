 ...
 */
	...
	'walled_garden_title_1' => "Vous faîtes partie du réseau La Mie Câline ?",
	'walled_garden_title_2' => "Nous vous invitons à entrer dans notre réseau collaboratif, un espace vous est réservé !",
	'walled_garden_description_1' => "Cette plateforme unique vous permettra de :",
	'walled_garden_description_2' => "Collaborer et échanger avec tous les membres partout en France",
	'walled_garden_description_3' => "Partager vos idées et voter pour vos préférées",
	'walled_garden_description_4' => "Suivre toute l’actualité de votre enseigne",
 ...
 */
	...
	'widgets:save:failure' => "Un problème est survenu lors de l'enregistrement de votre bloc d'infos. Veuillez recommencer.",
 ...
 */
	...
	'avatar:create:instructions' => "Cliquez et faites glisser un carré ci-dessous selon la façon dont vous voulez que votre photo de profil soit recadrée. Un aperçu s'affiche sur la droite. Lorsque vous êtes satisfait de l'aperçu, cliquez sur «Créez votre photo de profil. Cette version recadrée sera utilisée sur le site.",
 ...
 */
	...
	'river:update:user:avatar' => '%s a changé sa photo de profil',
 ...
 */
	...
	'search:bar' => "Rechercher des membres et du contenu",
	'search' => "Rechercher",
 ...
 */
	...
	'registerok' => "Vous vous êtes enregistré avec succès. Un email vous sera envoyé lorsque votre compte aura été validé par l'administrateur de %s",
 ...
 */
	...
	'deleteconfirmfolder' => "Souhaitez-vous également aussi supprimer tous les fichiers de ces répertoires ?",
 ...
 */
	...
	'js:security:token_refresh_failed' => "Connexion interrompue. Veillez à ce que vous soyez bien connecté.",
